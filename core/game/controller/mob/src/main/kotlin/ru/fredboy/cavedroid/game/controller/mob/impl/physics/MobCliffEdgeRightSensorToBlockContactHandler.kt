...
class MobCliffEdgeRightSensorToBlockContactHandler @Inject constructor(
    private val applicationContextRepository: ApplicationContextRepository,
) : AbstractContactHandler<Mob, Block>() {

    override val sensorType: ContactSensorType
        get() = ContactSensorType.MOB_CLIFF_EDGE_RIGHT
    ...
    override fun Mob.handleBeginContact(contact: Contact, entityB: Block) {
        cliffEdgeCounters[Direction.RIGHT.index]++
    }
