...
abstract class GamePhysicsController : ContactListener {
    ...
    override fun beginContact(contact: Contact?) {
        ...
        when {
            sensorType == ContactSensorType.MOB_ON_GROUND && mob != null && block != null -> mob.onTouchGround()
            sensorType == ContactSensorType.MOB_SHOULD_JUMP && mob != null -> mob.onShouldJump()
            sensorType == ContactSensorType.DROP_ON_GROUND && drop != null && block != null -> drop.onTouchGround()
            sensorType == ContactSensorType.DROP_ATTRACTOR && drop != null && mob != null -> drop.setAttractionTarget(mob)
            sensorType == ContactSensorType.DROP_PICK_UP && mob != null && drop != null -> mob.pickUpDrop(drop)
        }
    }
    ...
    override fun endContact(contact: Contact?) {
        ...
        val sensorType = contact.fixtureA.userData as? ContactSensorType
            ?: contact.fixtureA.userData as? ContactSensorType

        when {
            sensorType == ContactSensorType.MOB_ON_GROUND && mob != null && block != null -> mob.onLeaveGround()
            sensorType == ContactSensorType.DROP_ON_GROUND && drop != null && block != null -> drop.onLeaveGround()
            sensorType == ContactSensorType.DROP_ATTRACTOR && drop != null && mob != null -> drop.resetAttractionTarget()
        }
    }
