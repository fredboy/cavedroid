...
class AttributionMenuViewModelProvider @Inject constructor() : ViewModelProvider<AttributionMenuViewModel> {

    override val viewModelClass: KClass<AttributionMenuViewModel>
        get() = AttributionMenuViewModel::class

    override fun get(navKey: NavKey, navBackStack: NavBackStack): AttributionMenuViewModel {
