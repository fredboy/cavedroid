...
class HelpMenuViewModelProvider @Inject constructor() : ViewModelProvider<HelpMenuViewModel> {

    override val viewModelClass: KClass<HelpMenuViewModel>
        get() = HelpMenuViewModel::class

    override fun get(navKey: NavKey, navBackStack: NavBackStack): HelpMenuViewModel {
        return HelpMenuViewModel(navBackStack)
    }
}
