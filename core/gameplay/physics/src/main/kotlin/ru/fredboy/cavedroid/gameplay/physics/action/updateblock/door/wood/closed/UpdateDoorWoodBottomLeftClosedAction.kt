...
@GameScope
@BindUpdateBlockAction(stringKey = UpdateDoorWoodBottomLeftClosedAction.BLOCK_KEY)
class UpdateDoorWoodBottomLeftClosedAction @Inject constructor(
    private val gameWorld: GameWorld,
    private val getBlockByKeyUseCase: GetBlockByKeyUseCase,
) : IUpdateBlockAction {

    override fun update(x: Int, y: Int) {
        val top = getBlockByKeyUseCase["door_wood_top_left_closed"]
    ...
    companion object {
        const val BLOCK_KEY = "door_wood_bottom_left_closed"
    }
}
