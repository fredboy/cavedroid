...
@GameScope
@BindUpdateBlockAction(stringKey = UpdateDoorWoodTopLeftOpenAction.BLOCK_KEY)
class UpdateDoorWoodTopLeftOpenAction @Inject constructor(
    private val gameWorld: GameWorld,
    private val getBlockByKeyUseCase: GetBlockByKeyUseCase,
) : IUpdateBlockAction {

    override fun update(x: Int, y: Int) {
        val bottom = getBlockByKeyUseCase["door_wood_bottom_left_open"]
    ...
    companion object {
        const val BLOCK_KEY = "door_wood_top_left_open"
    }
}
