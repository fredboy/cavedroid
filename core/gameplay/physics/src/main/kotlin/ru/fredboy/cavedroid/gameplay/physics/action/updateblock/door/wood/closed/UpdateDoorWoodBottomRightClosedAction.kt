...
@GameScope
@BindUpdateBlockAction(stringKey = UpdateDoorWoodBottomRightClosedAction.BLOCK_KEY)
class UpdateDoorWoodBottomRightClosedAction @Inject constructor(
    private val gameWorld: GameWorld,
    private val getBlockByKeyUseCase: GetBlockByKeyUseCase,
) : IUpdateBlockAction {

    override fun update(x: Int, y: Int) {
        val top = getBlockByKeyUseCase["door_wood_top_right_closed"]
    ...
    companion object {
        const val BLOCK_KEY = "door_wood_bottom_right_closed"
    }
}
