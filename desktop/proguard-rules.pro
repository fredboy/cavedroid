...
# Keep all kotlinx.coroutines classes intact
-keep class kotlinx.coroutines.** { *; }

# Keep all suspend lambdas (necessary for Flow operators)
-keepclassmembers class * implements kotlin.coroutines.Continuation {
    <fields>;
    <methods>;
}

# Ignore warnings from optional/debug libraries
